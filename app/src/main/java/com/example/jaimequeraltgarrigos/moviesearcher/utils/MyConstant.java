package com.example.jaimequeraltgarrigos.moviesearcher.utils;
...
public class MyConstant {
    ...
    public static final String URL_SEARCH_MULTI = "3/search/multi";


    public static final String API_KEY = "9bc3a7bc8d59c59f5ce6afa05f9a3d60";
    public static final String MOST_POPULAR = "vote_average.desc";
}
